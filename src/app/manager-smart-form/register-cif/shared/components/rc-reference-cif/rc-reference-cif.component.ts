...
@Component({
  selector: 'app-rc-reference-cif',
  templateUrl: './rc-reference-cif.component.html',
  styleUrls: ['./rc-reference-cif.component.scss']
})
export class RcReferenceCifComponent implements OnInit {
