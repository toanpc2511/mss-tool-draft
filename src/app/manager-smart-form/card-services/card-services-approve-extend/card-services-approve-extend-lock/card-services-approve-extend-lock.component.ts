...
@Component({
  selector: 'app-card-services-approve-extend-lock',
  templateUrl: './card-services-approve-extend-lock.component.html',
  styleUrls: [
    './card-services-approve-extend-lock.component.scss',
    '../../shared/components/card-services-form/card-services-form.component.scss',
  ],
})
export class CardServicesApproveExtendLockComponent
  implements OnInit, AfterViewInit
{
  ...
  ngOnInit(): void {
    ...
    this.formEbsServiceInfo
      .get('actionCode')
      .setValue(this.cardEbsServiceSelected.subActionCode, {
        emitEvent: false,
      });
  ...
  initFormEbsService(): void {
    this.formEbsServiceInfo = this.fb.group({
      ...
      actionCode: [{ value: '', disabled: true }],
