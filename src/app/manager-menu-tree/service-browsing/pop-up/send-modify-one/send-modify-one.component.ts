...
@Component({
  selector: 'app-send-modify-one',
  templateUrl: './send-modify-one.component.html',
  styleUrls: ['./send-modify-one.component.css']
})
export class SendModifyOneComponent implements OnInit {
  title: any;
  content: any;
  hidden = false;
  note: string;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SendModifyOneComponent>
  ) { }
