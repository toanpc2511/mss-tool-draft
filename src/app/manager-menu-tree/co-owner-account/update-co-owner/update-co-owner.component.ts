...
declare var $: any;
@Component({
  selector: 'app-update-co-owner',
  templateUrl: './update-co-owner.component.html',
  styleUrls: ['./update-co-owner.component.css']
})
export class UpdateCoOwnerComponent implements OnInit {
