...
@Component({
  selector: 'app-dialog-form-beneficiary',
  templateUrl: './dialog-form-beneficiary.component.html',
  styleUrls: [
    '../../../../styles/common.scss',
    '../../../../styles/dialog.scss',
    './dialog-form-beneficiary.component.scss',
  ],
})
export class DialogFormBeneficiaryComponent implements OnInit {
  ...
  @ViewChild('formBeneficiary')
  formBeneficiary: ElementRef;
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any,
    private fb: FormBuilder,
    public dialogRef: MatDialogRef<DialogFormBeneficiaryComponent>
  ) {
      ...
      this.form.patchValue(
        {
          ...
          docType: DOC_TYPES_VI.find(
            (doc) => doc.noneMark === this.beneficiaryDetail?.docType
          )?.code,
        },
        NO_EMIT
      );
  ...
  onSubmit(): void {
    ...
    console.log('formBeneficiary', this.form);

    if (this.form.invalid) {
      FormHelpers.focusToInValidControl(this.formBeneficiary);
      return;
    }
  ...
  get beneficiaryDetail(): LEGAL_REPRESENTATIVE {
...
export class IDataBeneficiary {
  constructor(public beneficiary: LEGAL_REPRESENTATIVE) {}
}
