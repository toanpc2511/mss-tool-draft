...
import { COLUMNS_TRANSACTIONS, STATUS_TRANSACTION, STATUS_TRANSACTION2 } from '../../shared/constants/tuition.constant';
...
@Component({
  ...
  templateUrl: './tuition-approve-payment.component.html',
  styleUrls: ['./tuition-approve-payment.component.scss']
})
export class TuitionApprovePaymentComponent implements OnInit {

  statusTransactions = STATUS_TRANSACTION2;
  ...
  search(): any {
    ...
    if(this.formSearch.get('statusTransaction').value === 'TIMEOUT')
    {
      searchCondition = [
        {
