...
@Component({
  selector: 'app-lpb-single-address',
  templateUrl: './lpb-single-address.component.html',
  styleUrls: ['./lpb-single-address.component.scss']
})
export class LpbSingleAddressComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  getDataCurrentAddressForeign(): any {
    const result = {
      currentCountry: this.selectedCurrentCountry ? this.selectedCurrentCountry.code : '',
